		...
		<>
			<section className="px-4 sm:px-10 md:px-20">
				<input
					...
					className="w-1/2 xl:w-1/4 block mx-auto my-5 p-2 rounded-lg bg-gray-800 text-gray-100"
				/>
				{cData.length ? (
									...
									.map(coin => {
										...
										return (
											...
											>
												...
												<td className="py-6 text-left lg:pl-6 xl:pl-12 flex w-full overflow-hidden min-w-max">
													<LazyLoadImage
														src={coin.image}
														alt={coin.id}
														effect="blur"
													...
													<div className="whitespace-nowrap overflow-hidden overflow-ellipsis">
														<span>
															{coin.name} &nbsp;&nbsp;{' '}
															<span className="text-gray-500 whitespace-nowrap overflow-hidden overflow-ellipsis">
																{' '}
